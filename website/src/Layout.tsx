      ...
      <footer className="site-footer">
        <div className="footer-inner">
          ...
          <div className="footer-grid">
            ...
            <section className="footer-col" aria-labelledby="footer-learn"><h2 id="footer-learn">Guides</h2><a href="/blog/">Blog</a><a href="/docs/llms-txt/">llms.txt guide</a><a href="/docs/json-ld/">JSON-LD guide</a><a href="/docs/ai-crawlers/">AI crawlers guide</a></section>
            <section className="footer-col" aria-labelledby="footer-developers"><h2 id="footer-developers">Developers</h2><a className="footer-github-link" href="https://github.com/agentmarkup/agentmarkup" target="_blank" rel="noopener noreferrer"><GitHubIcon />GitHub</a><a href="https://github.com/agentmarkup/agentmarkup/issues" target="_blank" rel="noopener noreferrer">Issues</a><a href="https://www.npmjs.com/search?q=%40agentmarkup" target="_blank" rel="noopener noreferrer">Packages</a></section>
