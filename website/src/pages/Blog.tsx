...
function Blog() {
  ...
  const groups = [
    ...
    { label: 'Implementation guides', posts: blogPosts.filter((post) => ['agentmarkup-plugin-chatgpt-codex-claude-code', 'soft-404-ai-discoverability-tools', 'nuxt-llms-txt-json-ld', 'agentmarkup-cli-any-static-site', 'nextjs-llms-txt-json-ld', 'markdown-mirrors', 'when-markdown-mirrors-help'].includes(post.slug)) },
