...
function Blog() {
  ...
  const groups = [
    { label: 'AI visibility and research', posts: blogPosts.filter((post) => ['audit-ai-crawler-access', 'website-checker', 'brand-awareness-ai', 'ecommerce-llm-optimization', 'what-is-geo'].includes(post.slug)) },
    { label: 'Implementation guides', posts: blogPosts.filter((post) => ['nuxt-llms-txt-json-ld', 'agentmarkup-cli-any-static-site', 'nextjs-llms-txt-json-ld', 'markdown-mirrors', 'when-markdown-mirrors-help'].includes(post.slug)) },
